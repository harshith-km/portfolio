      ...
      <div className="container mx-auto px-6 py-20 md:py-32 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 max-w-3xl order-2 lg:order-1 text-left">
            ...
            >
              Full-Stack <span className="text-foreground font-semibold">Developer</span>
            </motion.h2>
            ...
            >
              Building performant, scalable web applications. Currently focused on 
              <span className="text-primary font-medium italic"> React</span> and 
              <span className="text-primary font-medium italic"> Distributed Systems</span>.
            </motion.p>
            ...
            >
              <a href="#projects" className="group px-8 py-4 bg-primary text-black font-bold flex items-center gap-3 hover:bg-primary/80 transition-all rounded-sm">
                View Projects
                <ArrowDown size={20} className="group-hover:translate-y-1 transition-transform" />
              </a>
              <a href="#contact" className="px-8 py-4 border border-border text-foreground hover:border-primary transition-all rounded-sm">
                Get in Touch
              </a>
            </motion.div>
            ...
            >
              ...
              <span className="font-mono text-sm tracking-widest">BANGALORE // IN</span>
            </motion.div>
          </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-mono text-[10px] uppercase tracking-tighter text-muted-foreground">Availability</p>
